...
/* globals: tilemap, refreshTilemap */


function loadTilemap(columns, rows, paths) {
    var tileset = document.getElementById('insert-tileset');

    window.columns = columns;
    window.rrows = rows;
    var html = '<img src="' + paths.split(', ')[0] + '"/>';
    tileset.innerHTML = html;
}
;
